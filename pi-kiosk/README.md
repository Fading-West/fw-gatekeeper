...
written, and a schema trigger freezes it before any worker row is deleted, so a
deactivation can no longer strand queued events. Rows written by older releases
